...
import { fetchPlaceListByHostNo } from '../../../place/api/host/place/placeApi';
            ...
            <SpaceGrid>
              {spaces.slice(0, 12).map((s, i) => (
                <SpaceItem key={s.placeNo ?? i}>
                  <ImageContainer>
                    {s.thumbnail ? (
                      <SpaceImage src={s.thumbnail} alt={s.spaceName} />
                    ) : (
