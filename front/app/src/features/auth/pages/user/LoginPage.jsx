...
const KakaoIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path
      d="M9 1.5C4.86 1.5 1.5 4.19 1.5 7.5c0 2.09 1.3 3.93 3.27 5.02l-.83 3.07 3.56-2.34C10 16.89 10.5 16.93 11 16.93 15.14 16.93 18.5 14.24 18.5 10.93S13.14 1.5 9 1.5z"
      fill="#3c1e1e"
    />
  </svg>
);
...
const GoogleIcon = () => (
  <svg width="16" height="16" viewBox="0 0 18 18">
    <path
      d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844c-.209 1.125-.843 2.078-1.796 2.717v2.258h2.908C18.622 12.814 17.64 11.108 17.64 9.2z"
      fill="#4285F4"
    />
    <path
...
function LoginPage() {
  ...
  // - 실패 시 에러 메시지 표시 (잠금 정책 응답도 처리)
  // - 성공 시 토큰 저장 후 /user/mypage 이동
  const handleLogin = (e) => {
    e.preventDefault();
  ...
  return (
    <AuthCard>
      ...
      <form onSubmit={handleLogin} noValidate>
        ...
        <BtnPrimary type="submit">로그인</BtnPrimary>
      </form>
