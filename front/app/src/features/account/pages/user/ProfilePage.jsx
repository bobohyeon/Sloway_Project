...
import { FaPencilAlt, FaUser, FaExclamationTriangle } from 'react-icons/fa';
  ...
  return (
    <Page>
      <PageHeader>
        ...
        <PageDesc>프로필과 연락처를 관리할 수 있어요</PageDesc>
      </PageHeader>
          ...
          return (
            <SocialRow key={acc.provider}>
              ...
              <ConnectBtn
                ...
                onClick={() => handleSocialToggle(acc.provider, acc.connected)}
              >
                {acc.connected ? '해제' : '연결'}
              </ConnectBtn>
            </SocialRow>
